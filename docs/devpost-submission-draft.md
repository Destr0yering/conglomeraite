...
**Video:** https://youtu.be/EeBFzSipKyY — a public 2:55 demo with the Microsoft Andrew neural male voice and a 14-second physical Jetson network-link-loss insert. The same artifact is committed at `artifacts/conglomeraite-demo.mp4`.
