...
- [ ] **Create the public repository.** The local Git repository has no commits, no remote, and no public URL.
...
5. Create the public GitHub repository, make the initial commit, push, verify the MIT license badge/About section, and test every public link in a private/incognito window.
