...
- [x] **Render the demo.** The Andrew neural-voice evidence cut is 2:55 at `artifacts/conglomeraite-demo.mp4`; a YouTube/Vimeo mirror is still required for Devpost's embed field.
